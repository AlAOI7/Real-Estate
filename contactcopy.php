        ...
        <div class="row">
            <div class="col-lg-4 mb-5 bg-primary">
                <div class="contact-info">
                    <h3 class="mb-4 mt-4 text-white">جهات الاتصال</h3>
                    <ul>
                        <li class="d-flex mb-4">
                            <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                            <div class="contact-address">
                                <h5 class="text-white">العنوان</h5>
                                <span class="text-secondary">شارع كولينز الغربي، فيكتوريا 8007، أستراليا</span>
                                <span class="text-secondary">شارع كولينز الغربي، فيكتوريا 8007، أستراليا</span>
                            </div>
                        </li>
                        <li class="d-flex mb-4">
                        ...
                        <li class="d-flex mb-4">
                            ...
                            <div class="contact-address">
                                <h5 class="text-white">عنوان البريد الإلكتروني</h5>
                            ...
                            <form class="w-100" action="#" method="post">
                                <div class="row">
                                    <div class="row mb-4">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <input type="text" name="email" class="form-control" placeholder="عنوان البريد الإلكتروني*">
                                        </div>
                                        <div class="form-group col-lg-6">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <textarea name="message" class="form-control" rows="5" placeholder="اكتب تعليقاتك..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" value="send message" name="send" class="btn btn-primary">إرسال الرسالة</button>
                                </div>
                            </form>
                        </div>
                    </div>

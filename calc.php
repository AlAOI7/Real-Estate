...
<div class="full-row bg-gray">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-12">
                <h2 class="text-secondary double-down-line text-center">حاسبة EMI</h2>
            </div>
        </div>
        <center>
            <table class="items-list col-lg-6" style="border-collapse:inherit;">
                <thead>
                    <tr class="bg-primary">
                        <th class="text-white font-weight-bolder">السعر</th>
                        <th class="text-white font-weight-bolder">المبلغ</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="text-center font-18">
                        <td><b>أدخل المبلغ</b></td>
                        <td><b><?php echo $amount; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>أدخل الشهر</b></td>
                        <td><b><?php echo $mon; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>أدخل معدل الفائدة</b></td>
                        <td><b><?php echo $int; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>إجمالي الفائدة</b></td>
                        <td><b><?php echo $interest; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>إجمالي المبلغ</b></td>
                        <td><b><?php echo $pay; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>الدفعة الشهرية (EMI)</b></td>

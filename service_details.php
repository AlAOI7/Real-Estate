...
<style>
  .service-details-container {
    max-width: 600px;
    margin: 40px auto; /* توسيط العرض مع تباعد من الأعلى */
    padding: 20px;
    background: #fff;
    border-radius: 10px;
  ...
  .service-details-container .btn-order {
    background-color: #007bff; /* أزرق bootstrap */
    color: white;
    padding: 12px 30px;
    font-size: 1.2rem;
    border: none;
...
<a href="tel:+967773748697" class="btn btn-primary ">
    ...
    <a href="order.php?service_id=<?php echo intval($service['id']); ?>" class="btn-order" title="طلب الخدمة">
